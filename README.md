...
**Windows**: 
1.  Install and run  
    - *If you have trouble to run the build, you might need to install the following runtimes:*
      - [MicrosoftEdgeWebView2RuntimeInstallerX64](https://github.com/SoftFever/BambuStudio-SoftFever/releases/download/v1.0.10-sf2/MicrosoftEdgeWebView2RuntimeInstallerX64.exe)  
      - [vcredist2019_x64](https://github.com/SoftFever/BambuStudio-SoftFever/releases/download/v1.0.10-sf2/vcredist2019_x64.exe)  

**Mac**:
1. Download the DMG for your computer: `arm64` version for Apple Silicon and `x86_64` for Intel CPU.  
2. Drag the OrcaSlicer.app to the Application folder. 
...
Their generous support enabled me to purchase filaments and other essential 3D printing materials for the project.   
Thank you! :)
...
The Bambu networking plugin is based on non-free libraries from Bambulab. It is optional for the Orca Slicer and provides extended functionalities for Bambulab printer users.

## ToDos  
[ ] Check the communication with OctoPrint,  
[ ] Check the packing and its g-code generation for multiple print beds,
